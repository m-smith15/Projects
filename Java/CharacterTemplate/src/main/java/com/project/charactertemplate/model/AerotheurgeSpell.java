...
@Entity
@Table(name="aerotheurge")
public class AerotheurgeSpell {
...
//	private Spell spell;
	...
	public AerotheurgeSpell() {}
	
	public AerotheurgeSpell(String name, String description, String requiredLevel, String memorySlots,
